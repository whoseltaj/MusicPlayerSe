    ...
    return (
        ...
        <div className="wrapperr">
            ...
            <div className="main-container">
                   <div className="main-header anim" style={{'--delay': '0s'}}>Information</div>
                   <p className="infordas">We aim to develop a music player software tailored for music enthusiasts seeking a personalized listening experience. It will feature intuitive music organization, high-quality audio playback, customizable user interfaces, support for a wide range of audio formats.In this Music Player you can listen music from different type of genres.</p>
                   <div className="main-header anim" style={{'--delay': '0s'}}>Future Plans</div>
                   <p className="futurepl">In the future, the application will further develop and different functions will be added:
                    <br />
                    1.Create Playlist.
                    <br />
                    2.Liked Music.
                    ...
                    4.Music Search.
                    <br />
                    5.Search Other User's Playlists
                   </p>

                   <div className='anipla'> 
                   <ul>
                      <li>M</li>
                      <li>U</li>
                      <li>S</li>
